...
@Controller
@RequestMapping(value="/admin/studiomem")
public class AdminStudiomemController {
		...
		if(developer!=null){
			...
			if (stumemIs!=null){
				...
				if (i>1 || i<7){
					...
					return ResultUtil.error("工作室Id有误");
					//}
...
/*Developer developer=(Developer) request.getSession().getAttribute("developer");
		...
		return ResultUtil.success(studiomem,"gongzuoshi");
		*/
/*}
		return ResultUtil.error("你没有登录,请登录再试");*//*
