...
@Service("ProdetamemServiceImpl")
public class ProdetamemServiceImpl implements ProdetamemService {
	@Autowired
	...
	public Result deleteProdetamem(Prodetamem prodetamem) {
		if (prodetamem.getPrdememSum() != 0) {
			...
			prodetamem2.setPrdememSum(prodetamem.getPrdememSum());
			Prodetamem prodetamem1 = prodetamemDao.selectOneProdetamem2(prodetamem2);
			if(prodetamem1!=null){
				if (prodetamem1.getPrdememState() == 0) {
