...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/PersonalIndexJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					<h1 class="lead pd-t-20">个人主页
						<span class="pull-right" style="font-size: 16px; margin-right: 20px">
					点赞：	<i class="fa fa-thumbs-o-up red" title="点赞数"></i> <span id="Idpraise"></span>
					</h1>
				...
				<div class="form-group">
					<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>用户ID：</label>
					<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user-o"></i></span>
							<input type="text" value="" id="IpdevId"  name="devId" class="form-control" disabled="disabled" >
						</div>
						<label></label>
					</div>
				</div>
				<div class="form-group">
    					<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>学号：</label>
   							 <div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
       						 <div class="input-group">
            					<span class="input-group-addon"><i class="fa fa-address-book"></i></span>
                        		<input type="text" value="" id="IpdevNumber"  name="devNumber" class="form-control" disabled="disabled" >
                    		</div>
       						<label></label>
   					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>邮箱：</label>
						 <div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
                    		...
                    		<input type="email" value="" id="IpdevEmail"  name="devEmail" class="form-control" disabled="disabled">
                		</div>
   						 <label></label>
		   				</div>
					</div>
						<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user-o"></i></span>
									<input class="form-control input_public" id="IpdevName" type="text" name="devName" value="" disabled="disabled">
								</div>
								<label></label>
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>姓名：</label>
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<input class="form-control input_public" id="IpdevTruename" type="text" name="devTruename" value="" disabled="disabled">
								</div>
							<label></label>
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>是否实名认证：</label>
						...
						<div class="form-group">
						<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>学校所在地：</label>
						<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-mortar-board"></i></span>
								<input class="form-control input_public" id="IpdevSchool" type="text" name="devSchool" value="" disabled="disabled">
							</div>
						<label ></label>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input class="form-control" id="IpdevPhone" name="devPhone" type="text" disabled="disabled" value="" >
								</div>
								<label class="input-group" for=""></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input class="form-control input_public" id="IpdevLocation" type="text" name="devLocation" value="" disabled="disabled">
								</div>
							...
							<div class="form-group">
								<label class="col-sm-3 col-md-3 col-lg-3 control-label" style="vertical-align: middle;">擅长项目：</label>
								<div class="col-sm-5 col-md-5 col-lg-5" style="">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-clone"></i></span>
										<input class="form-control input_public" id="IpdevSpeciality" type="text" name="devSpeciality" value="" disabled="disabled">
									</div>
									<label id="IpdevLocation-error" class="red error" for="IpdevLocation"></label>
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-md-9 col-lg-9">
								<textarea class="form-control" id="IpdevInfo" name="devInfo" cols="" rows="5" disabled="disabled" maxlength="200" onchange="this.value=this.value.substring(0, 200)" onkeydown="this.value=this.value.substring(0, 200)" onkeyup="this.value=this.value.substring(0, 200)" placeholder="可输入200字.."></textarea>
