...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/ReleaseStudioJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal" method="post" id="ReStudioFrom">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>特长：</label>
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-bookmark-o"></i></span>
									<input class="form-control input_public" id="IpstuSpeciality" type="text" name="stuSpeciality" value="" placeholder="请输入特长...">
								</div>
