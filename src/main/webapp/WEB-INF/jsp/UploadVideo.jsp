...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/UploadVideoJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal" id="UpVideoFrom" enctype="multipart/form-data">
						<div class="form-group">
		    					<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>视频标题：</label>
		   							 <div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
		                        		<input type="text" value="" id="IpforumName"  name="forumName"  class="form-control " placeholder="请输入标题..." required="required" maxlength="20" onchange="this.value=this.value.substring(0, 20)" onkeydown="this.value=this.value.substring(0, 20)" onkeyup="this.value=this.value.substring(0, 20)">
		       						<label id="IpforumName-error" class="red error" for="IpforumName"></label>
		   					</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label">视频简介：</label>
							<div class="col-sm-9 col-md-9 col-lg-9">
								<textarea class="form-control" name="forumInfo" cols="" required="required" rows="5" maxlength="100" onchange="this.value=this.value.substring(0, 100)" onkeydown="this.value=this.value.substring(0, 100)" onkeyup="this.value=this.value.substring(0, 100)" placeholder="可输入100字.."></textarea>
								<label></label>
							</div>
						</div>
						<div class="form-group">
								<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>视频类型：</label>
								<div class="col-sm-3 col-md-3 col-lg-3">
								<select id="IpdevSpeciality" name="forumType" class="selectpicker" multiple  data-max-options="5" data-live-search="true" data-size="4">
									<option id="OpforumType" disabled>---请选择---</option>
								</select>
								<label id="IpdevSpeciality-error" class="red error" for="IpdevSpeciality"></label>
								</div>
								<label class="col-sm-2 col-md-2 col-lg-2 control-label"><span class="red">*</span>视频状态：</label>
								<div class="col-sm-3 col-md-3 col-lg-3" >
								<select id="IpforumStart" name="forumStart" class="selectpicker">
					   ...
					   <div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>上传视频：</label>
							<div class="col-sm-9 col-md-9 col-lg-9">
							<input type="file" class="form-control text-input" id="IpUpdevVideo" name="devVideo" data-bind="none">
							</div>
						</div>
					</form>
