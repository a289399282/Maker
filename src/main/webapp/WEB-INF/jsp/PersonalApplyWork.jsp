...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/PersonalApplyWorkJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
	...
	<body>
        ...
        -->
		   <div class="modal fade" id="CheckDetailsModel" tabindex="-1" role="dialog"
						...
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label">发布人名称：</label>
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
						...
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label">职位要求：</label>
