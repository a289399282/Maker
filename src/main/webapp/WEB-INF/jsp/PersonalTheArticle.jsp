...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/PersonalTheArticleJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					<h1 class="lead pd-t-20">我的文章
						<span class="pull-right">
							<%--<a href="javacript:void(0)" onclick="removeMuch()" class="btn btn-primary btn-primary-white btn-sm">删除多个文章</a>--%>
							<!--<a href="javacript:void(0)" class="btn btn-primary btn-primary-white btn-sm">修改支付密码</a></span>-->
					</h1>	
					<table class="table text-nowrap" id="TheArticleTable"></table>
