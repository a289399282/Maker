...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/PublishTheWorkJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal" method="post" id="PuWorkFrom">
