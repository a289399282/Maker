...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath }/js/LookWorkJS.js" type="text/javascript" charset="utf-8"></script>
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 nopadding-left">
	...
	<div class="panel paihang" style="margin-bottom: 30px;">
		<div class="panel-heading">
			<h3 class="panel-title" style="text-align: left;"> <span class="green">|</span>&nbsp;最新职位</h3>
		</div>
	...
	<div class="panel paihang">
		<div class="panel-heading">
			<h3 class="panel-title" style="text-align: left;"><span class="green">|</span>&nbsp;最热职位</h3>
		</div>
		<div class="panel-body">
