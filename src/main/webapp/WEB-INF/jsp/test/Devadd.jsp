...
<form action="${pageContext.request.contextPath }/developer/insertDev" method="post" enctype="multipart/form-data">
添加开发人员信息：
...
<tr>
	<td>身份证</td>
	<td><input type="text" name="devIdcard" value=""/></td>
</tr>
<tr>
	<td>所在地</td>
...
<tr>
	<td>邮箱</td>
	<td><input type="text" name="devEmail" value=""/></td>
</tr> 
<tr>
	<td>特长</td>
