...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/PersonalWorkMemJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
	...
	<body>
        ...
        -->
		    <div class="modal fade" id="UpdateModel" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">申请人状态</h4>
                                </div>
					...
					<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input type="hidden" name="posMemId" id="IdposMemId" value="" />
									<input class="form-control input_public" id="IdpositionIdName" type="text" name="positionIdName" value="" disabled="disabled">
								</div>
							<label></label>
							</div>
					...
					<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red"></span>申请人：</label>
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
									<input class="form-control input_public" id="IdpositionmemIdName" type="text" name="positionmemIdName" value="" disabled="disabled">
								</div>
							<label></label>
							</div>
