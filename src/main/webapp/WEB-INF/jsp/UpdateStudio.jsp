...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/UpdateStudioJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="updateCompetition" enctype="multipart/form-data">
					<input type="file" class="form-control text-input" id="IdUpstuImg" name="stuImg" data-bind="none">
				...
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal">
						<div class="form-group" >
										<label class="col-sm-3 col-md-3 col-lg-3 control-label" style="line-height: 150px;">上传工作室头像：</label>
						...
						<form class="form-horizontal" method="post" id="UpdateStudioFrom">
						<div class="form-group">
		    					<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>工作室名称</label>
		   							 <div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
		   							 		<input type="hidden" value="" id="IpstuId" name="stuId"  class="form-control ">
		                        		<input type="text" value="" id="IpstuName" name="stuName"  class="form-control " placeholder="请输入标题..." >
		       						<label id="IpstuName-error" class="red error" for="IpstuName"></label>
		   					</div>
						</div>
					<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input class="form-control input_public" id="IpstuPhone" type="text" name="stuPhone" value="" placeholder="请输入电话号码...">
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input class="form-control input_public" id="IpstuEmail" type="email" name="stuEmail" value="" placeholder="请输入邮箱...">
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input class="form-control input_public" id="IpstuLocation" type="text" name="stuLocation" value="" placeholder="请输入所在地...">
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 col-md-8 col-lg-8">
								<textarea class="form-control" name="stuInfo" cols="" rows="5" maxlength="100" onchange="this.value=this.value.substring(0, 100)" onkeydown="this.value=this.value.substring(0, 100)" onkeyup="this.value=this.value.substring(0, 100)" placeholder="可输入100字.."></textarea>
								<label></label>
							</div>
						</div> 
							<div class="form-group">
								<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>工作室特长：</label>
								<div class="col-sm-3 col-md-3 col-lg-3">
								<select id="IpstuSpeciality" name="stuSpeciality" required="required" class="selectpicker" multiple  data-max-options="5" data-live-search="true" data-size="4">
									<option disabled>---请选择---</option>
								</select>
								<label id="IpstuSpeciality-error" class="red error" for="IpstuSpeciality"></label>
								</div>
							</div>
