...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/ProjectDetailsJS.js" type="text/javascript" charset="utf-8"></script>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">选择发布人</h4>
					</div>
					<div class="modal-body">
						<form  class="form-horizontal" id="updateTeam">
							<input type="hidden" name="proId" id="upproId" value="" />
							<div class="form-group">
								<label class="col-sm-4 col-md-4 col-lg-4 control-label"><span class="red">*</span>选择个人或工作室发布：</label>
								<div class="col-sm-4 col-md-4 col-lg-4">
									<select id="IdprdememId" name="prdememId" class="selectpicker" data-live-search="true">
										<option disabled>---请选择---</option>
										<option  value="null">个人</option>
									</select>
									<label id="IdprdememId-error" class="red error" for="IdprdememId"></label>
								</div>
							</div>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-primary" id="Subtn" data-dismiss="modal">提交
								</button>
			...
			<div class="col-md-12 detail-area">
				...
				<div class="row upper">
					...
					<div class="col-md-12">
						<div class="title-area">
							<span class="site-font-18" id="IdproName" style="font-size: 17px"> </span>&nbsp;&nbsp;
								<span class="" style="font: normal normal 13px/13px Microsoft YaHei;color:#5ECB13;" id="IdproMoney" ></span>
								<br>
							
							
							<!-- <div id="joinPracticeDiv"> -->
							<button id="joinPracticeDiv" onclick="Bidding()" style="margin-top:-31px;">竞标</button>
							<!-- </div> -->
						...
						<ul class="list-unstyled list-inline blog-info description" style="font-size: 13px;">
							<li class="description-item" title="负责人"><i class="fa fa-user-o"></i> <span class="icon-text-defalut" id="IdproPubname"></span></li>
							<li class="description-item" title="所在地"><i class="fa fa-home"></i> <span class="icon-text-defalut" id="IdproCity"> </span></li>
							<li class="description-item" title="热度"><i class="fa fa-fire red"></i> <span class="icon-text-defalut" id="IdproHeat"></span></li>
							<li class="description-item" title="发布时间"><i class="fa fa-calendar"></i> <span class="icon-text-defalut" id="IdproReltime"></span></li>
						</ul>
				...
				<div class="row no-margin lower">
					...
					<div class="tab-content">
						...
						<p style="line-height:150%"><strong><span style="font-size:21px;line-height:150%;font-family:'微软雅黑',sans-serif;color:#262626">项目介绍</span></strong></p>
						<p style="line-height:150%"><span style=";line-height:150%;font-family:'微软雅黑',sans-serif;color:#7F7F7F" id="IdproInfo"> </span></p>
						</div>
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 nopadding-left">
       ...
       <div class="panel paihang" style="margin-top: 38px;">
            ...
            <div class="panel-body">
       			<div class="touxiang"><img src="" name="Img" id="IpImg" title="" alt="" /></div>
     ...
     <form id="ProFrom">
		 <input type="hidden" name="proPublisher" id="upproPublisher" value="" />
     	<input type="hidden" name="prdememId" id="upprdememId"  value="" />
     </form>
    </div>
