...
<html>
	<head>
		...
		<!--<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/content_css/summernote.css"/>-->
		...
		<!--<script src="${pageContext.request.contextPath }/content_js/summernote.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath }/content_js/summernote-zh-CN.min.js" type="text/javascript" charset="utf-8"></script>-->
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/content_css/cityselect.css" media="all"/>
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/content_css/bootstrap-datepicker3.css" media="all"/>
		...
		<script src="${pageContext.request.contextPath }/content_js/cityselect.js" type="text/javascript" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath }/js/nav_left.js" type="text/javascript" charset="utf-8"></script>
    	<script src="${pageContext.request.contextPath }/js/UpdateTheProjectJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal" method="post" id="PuProjectFrom">
						<div class="form-group">
		    					<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>项目名称</label>
		                        		...
		                        		<input type="text" value="" id="IdproName" name="proName"  class="form-control " placeholder="请输入标题..." >
		       						<label id="IdproName-error" class="red error" for="IdproName"></label>
		   					</div>
						</div>
					<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>发布城市：</label>
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
									<input class="form-control"  id="IdproCity" type="text" name="proCity" value="" placeholder="请输入发布城市...">
								</div>
							<label id="IdproCity-error" class="red error" for="IdproCity"></label>
							</div>
							
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>薪酬：</label>
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-money"></i></span>
									<input class="form-control input_public" id="IdproMoney" type="text" name="proMoney" value="" placeholder="请输入薪酬...">
								</div>
							<label id="IdproMoney-error" class="red error" for="IdproMoney"></label>
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
									...
									<input class="form-control input_public" id="IdproEndtime" type="text" name="proEndtime" value="" placeholder="请输入截止时间...">
								</div>
							<label id="IdproEndtime-error" class="red error" for="IdproEndtime"></label>
							</div>
							
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label">项目描述：</label>
							<div class="col-sm-8 col-md-8 col-lg-8">
							<div>
								<textarea id="IdproInfo" class="form-control" required="required" name="proInfo" cols="" rows="5" maxlength="100" onchange="this.value=this.value.substring(0, 500)" onkeydown="this.value=this.value.substring(0, 500)" onkeyup="this.value=this.value.substring(0, 500)" placeholder="可输入500字.."></textarea>
								</div>
								<label id="IdproInfo-error" class="red error" for="IdproInfo"></label>
							</div>
						</div> 
							<div class="form-group">
								<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>项目类型：</label>
								<div class="col-sm-3 col-md-3 col-lg-3">
								<select id="IdproType" name="proType" required="required" class="selectpicker" multiple  data-max-options="5" data-live-search="true" data-size="4">
									<option disabled>---请选择---</option>
								</select>
								<label id="IdproType-error" class="red error" for="IdproType"></label>
								</div>
								<label class="col-sm-2 col-md-2 col-lg-2 control-label"><span class="red">*</span>项目状态：</label>
								<div class="col-sm-3 col-md-3 col-lg-3">
								<select id="IdproState" name="proState" required="required" class="selectpicker">
										<option selected disabled>---请选择---</option>
									    <option value="0">保存</option>    
									    <option value="1">发布</option>    
								</select>
								<label id="IdproState-error" class="red error" for="IdproState"></label>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>选择个人或工作室发布：</label>
								<div class="col-sm-3 col-md-3 col-lg-3">
								<select id="IdproPublisher" name="proPublisher" required="required" class="selectpicker" data-live-search="true">
									<option disabled selected>---请选择---</option> 
									<option id="personlOP" value="null">个人</option> 
								</select>
								<label id="IdproPublisher-error" class="red error" for="IdproPublisher"></label>
								</div>
							</div>
