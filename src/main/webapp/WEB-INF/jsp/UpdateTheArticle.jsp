...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/UpdateTheArticleJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
						...
						<div class="col-sm-4 col-md-4 col-lg-4" style="margin-top: 50px;">
							...
							<div class="panel paihang">
								...
								<div class="panel-body">
									<input type="file" class="form-control text-input"  accept="image/png,image/gif,image/jpeg" name="forumPic">
