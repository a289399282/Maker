...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/LookHonorStudioJS.js" type="text/javascript" charset="utf-8"></script>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding-left">
    ...
    <!--    </div>-->
      <div id="tab-html" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 tab-content-container">
            <!--全部-->
          <label><h2><span class="green">|</span> 工作室荣誉榜单</h2></label>
