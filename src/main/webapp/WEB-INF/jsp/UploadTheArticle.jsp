...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/content_css/thinker-md.vendor.css"/>
		...
		<script src="${pageContext.request.contextPath }/content_js/thinker-md.vendor.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="${pageContext.request.contextPath }/js/nav_left.js" type="text/javascript" charset="utf-8"></script>
    	<script src="${pageContext.request.contextPath }/js/UploadTheArticleJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			...
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>文章标题：</label>
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<input type="text" value="" id="IpforumName" required="required" name="forumName"  class="form-control " placeholder="请输入标题..." maxlength="20" onchange="this.value=this.value.substring(0, 20)" onkeydown="this.value=this.value.substring(0, 20)" onkeyup="this.value=this.value.substring(0, 20)">
								<label id="IpforumName-error" class="red error" for="IpforumName"></label>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label">文章简介：</label>
							<div class="col-sm-7 col-md-7 col-lg-7">
								<textarea class="form-control" required="required" id="IdforumInfo" name="forumInfo" required="required" cols="" rows="3" maxlength="100" onchange="this.value=this.value.substring(0, 100)" onkeydown="this.value=this.value.substring(0, 100)" onkeyup="this.value=this.value.substring(0, 100)" placeholder="可输入100字.."></textarea>
								<label></label>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>文章类型：</label>
							<div class="col-sm-3 col-md-3 col-lg-3">
								<select id="IpdevSpeciality" required="required" name="forumType" class="selectpicker"  multiple  data-max-options="5" data-live-search="true" data-size="4">
									<option id="OpforumType" disabled>---请选择---</option>
								</select>
								<label id="IpdevSpeciality-error" class="red error" for="IpdevSpeciality"></label>
							</div>
							<label class="col-sm-2 col-md-2 col-lg-2 control-label"><span class="red">*</span>文章状态：</label>
							<div class="col-sm-3 col-md-3 col-lg-3" >
								<select id="IpforumStart" required="required" name="forumStart" class="selectpicker">
									<option disabled>---请选择---</option>
									<option value="0">保存</option>
									<option selected value="1">发布</option>
								</select>
								<label id="IpforumStart-error" class="red error" for="IpforumStart"></label>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-8 col-md-8 col-lg-8">
								<label class="col-sm-3 col-md-3 col-lg-3 control-label">文章内容：</label>
								<div class="col-sm-9 col-md-9 col-lg-9">
									<!--<div name="forumText" class="summernote" id="IpforumText"></div>	-->
									<textarea class="form-control" id="md" data-provide="markdown" data-hidden-buttons="cmdImage" required="required" id="IdforumText" name="forumText" required="required" cols="" rows="19" maxlength="5000" onchange="this.value=this.value.substring(0, 5000)" onkeydown="this.value=this.value.substring(0, 5000)" onkeyup="this.value=this.value.substring(0, 5000)" placeholder="可输入5000字.."></textarea>
									<label></label>
								</div>
							</div>
					</form>
					<form  id="uploadformid" enctype="multipart/form-data">
						<div class="col-sm-4 col-md-4 col-lg-4" style="margin-top: 50px;">

							<div class="panel paihang">
								<div class="panel-heading">
									<h3 class="panel-title" style="text-align: left;"><span class="red">|</span> 图片上传</h3>
								</div>
								<div class="panel-body">
									<input type="file" class="form-control text-input" accept="image/png,image/gif,image/jpeg" id="file"name="forumPic">
									<button class="btn btn-primary float-right"  type="button" id="uploadImage" style="float: right; margin-top: 10px; margin-right: 10px;" >插入</button>
								</div>
							</div>
				...
				<div class="form-group"><br>
					...
					<div class="col-sm-5 col-md-5">
						<input class="col-md-6 btn btn-primary" id="Subtn" type="button" value="保存">
					</div>
				</div>
				</div>
			</div>
