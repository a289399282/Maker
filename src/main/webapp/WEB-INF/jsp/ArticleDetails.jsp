...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/ArticleDetailsJS.js" type="text/javascript" charset="utf-8"></script>
				...
				<div class="row upper">
					...
					<div class="col-md-12">
						<div class="title-area">
							<span class="site-font-18" id="IdArtName" style="font-size: 18px;"></span>&nbsp;&nbsp;
								<span class="" style="font: normal normal 13px/13px Microsoft YaHei;color:#5ECB13;" id="IdforumForid"></span>
								<br>
							
							
							<!-- <div id="joinPracticeDiv"> -->
							<button id="joinPracticeDiv" onclick="Bidding()" style="margin-top:-31px;">转发</button>
							<!-- </div> -->
				...
				<div class="row no-margin lower">
					...
					<ul class="nav project-content-tabs">
						<li class="active">
			                ...
			                <a href="#ArticleInfo" data-toggle="tab">文章简介</a>
			            </li>
						<li>
			                <div class="active-underline"></div>	
			                <a href="#ArticleText" data-toggle="tab">文章内容</a>
			            </li>
						
					</ul>
					<!-- 项目内容项 -->
					<div class="tab-content">
						<div id="ArticleInfo" class="tab-pane fade active cactive in">
							<p>
							</p>
						<p style="line-height:150%"><strong><span style="font-size:21px;line-height:150%;font-family:'微软雅黑',sans-serif;color:#262626">文章简介</span></strong></p>
						<p style="line-height:150%"><span style=";line-height:150%;font-family:'微软雅黑',sans-serif;color:#7F7F7F" id="IdInfo"> </span></p>
						</div>
						<div id="ArticleText" class="tab-pane fade container">
							<p>
							</p>
						<p style="line-height:150%"><strong><span style="font-size:21px;line-height:150%;font-family:'微软雅黑',sans-serif;color:#262626">文章内容</span></strong></p>
						<p style="line-height:150%"><span style=";line-height:150%;font-family:'微软雅黑',sans-serif;color:#7F7F7F"><article id="IdText"></article></span></p>
						</div>
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 nopadding-left">
     ...
     <form id="ProFrom">
     	<input type="hidden" name="forumId" id="upforumId" />
     	<input type="hidden" name="devId" id="updevId" />
     </form>
    </div>
