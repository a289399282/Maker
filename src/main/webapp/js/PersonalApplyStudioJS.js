    $(function () {
    	$('#ApplyStudioTable').bootstrapTable('destroy'); 
            //初始化Table
        ...
        var TableInit = function () {
            ...
            oTableInit.Init = function () {
                $('#ApplyStudioTable').bootstrapTable({
                    ...
                    columns: [
                       {
                            ...
                            title: '操作',
                            formatter: function (value, row, index) {
                                var d='<a onclick="removeID(\''+row.stuId+'\',\''+row.stumemSum+'\')" title="撤销申请" style="cursor: pointer">撤销申请</a>';
                                return d;
                            }
                        },
                    ],
...
//                    if (data.code == 1) {
//                          alert("删除成功");
//                     $('#ApplyStudioTable').bootstrapTable('remove', {
//		                    field: 'stuId',
//		                    values: [row.stuId]
//		                });
//                    }else{
...
//      }
        ...
        /*刷新table*/
        function reLoad() {
            $('#ApplyStudioTable').bootstrapTable('refresh');
        }
...
function CheckDetails(stuId){
	   $('#CheckDetailsModel').modal({backdrop: "static"})
	    $.ajax({
        type: "post",
        url: "/Maker/studio/selectStuById",   //查看详情URL
        data: {
            stuId: stuId
        },
