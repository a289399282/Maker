...
function AjaxAllProject(fenye,fieldSearch){
	var object = new Object();
		...
		object.fenye = fenye;
		object.forumWhat =parseInt('2');
    object.forumName = (fieldSearch?fieldSearch:"");
	$.ajax({
...
function GenerProjectOfTemplate(data){
	var template = '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 not-padding project-container ">'
                  +' <div class="project-title"><h2 class="post-title"><a class="post-link" href="ArticleDetails?id=IdText">NameText</a></h2><p style="margin-top: 10px;">ReltimeText</p><span class="projectmoney">(zhuanfaText)</span></div>'
	...
	var zhuanfa = '';
	if(data.forumForid != null && data.forumForid != "" && data.forumForid !=undefined){
        zhuanfa = '转发'
	}else{
        zhuanfa = '原创'
	}
