...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/UpdateVideoJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal" id="UpdateVideoFrom" enctype="multipart/form-data">
					   ...
					   <div class="form-group">
							<label class="col-sm-5 col-md-5 col-lg-5 control-label"><span class="red">*已上传的视频内容不允许更改！！！</span></label>
