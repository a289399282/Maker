...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/content_css/bootstrap-datepicker3.css"/>
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/content_css/cityselect.css"/>
    	...
    	<script src="${pageContext.request.contextPath }/js/PublishTheProjectJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-3 col-md-3 col-lg-3">
								<select id="IdproPublisher" name="proPublisher" class="selectpicker" data-live-search="true">
									<option disabled>---请选择---</option>
