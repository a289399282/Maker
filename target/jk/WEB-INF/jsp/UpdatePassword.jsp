...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/UpdatePasswordJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal" id="UpPassWFrom">
							<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>原密码：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
												<input type="password" value="" id="IpdevPassWord"  name="devPassWord" class="form-control" placeholder="请输入原密码...">
											<label id="IpdevPassWord-error" class="red error" for="IpdevPassWord"></label>
										</div>
									</div>
							<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>新密码：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
												<input type="password" value="" id="IpdevPassWordOne"  name="devPassWordOne" class="form-control" placeholder="请输入新密码...">
											<label id="IpdevPasswordOne-error" class="red error" for="IpdevPasswordOne"></label>
										</div>
							</div>
						<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>再次输入新密码：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
												<input type="password" value="" id="IpdevPassWordTwo"  name="devPassWordTwo" class="form-control" placeholder="请再输入一遍新密码...">
											<label id="IpdevPassWordTwo-error" class="red error" for="IpdevPassWordTwo"></label>
										</div>
						</div>
