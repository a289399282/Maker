...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/PersonalProjectOrdersJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
                            ...
                            <div class="modal-content">
                                ...
                                <div class="form-group">
									...
									<div class="input-group">
											...
											<input class="form-control input_public" id="IdproFoutime" type="text" name="proFoutime" value="">
										</div>
								...
								<div class="form-group">
									...
									<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input class="form-control input_public" id="IdproReltime" type="text" name="proReltime" value="">
										</div>
								...
								<div class="form-group">
									...
									<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input class="form-control input_public" id="IdproEndtime" type="text" name="proEndtime" value="">
										</div>
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<table id="ProjectOrdersTable"></table>
