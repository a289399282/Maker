...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/content_css/fileinput.min.css"/>
	...
	<script src="${pageContext.request.contextPath}/content_js/fileinput.min.js" type="text/javascript" charset="utf-8"></script>
	<script src="${pageContext.request.contextPath}/content_js/zh.js" type="text/javascript" charset="utf-8"></script>
	...
	<script src="${pageContext.request.contextPath}/js/UpdatePersonalJS.js" type="text/javascript" charset="utf-8"></script>
	<style type="text/css">
		.mmDiv {
			display:none;
		}
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="updateCompetition">
					<input type="file" class="form-control text-input" id="IpUpdevPic" name="devPic" data-bind="none">
					...
					<div class="col-md-12 nopadding">
						<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
							<div class="refound-account fund-account board">
								<h1 class="lead pd-t-20">修改资料
									<span class="pull-right">
								</h1>
								<form class="form-horizontal" id="updatePersonal" enctype="multipart/form-data">
									<div class="form-group" >
										<label class="col-sm-3 col-md-3 col-lg-3 control-label" style="line-height: 150px;">修改头像：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" >
											<div class="input-group mid">
												<div class="touxiang"><img src="" id="IpdevPic" title="" alt="" /></div>

											</div>
											<div class="mid">
												<button type="button" class="btn btn-primary" class="modal-title" id="upDevPic">
													上传头像
												</button>
											</div>
									...
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>绑定学号：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<div class="input-group">
												<span class="input-group-addon"><i class="fa fa-address-book"></i></span>
												<input type="text" value="" id="IpdevNumber"  name="devNumber" class="form-control" placeholder="请绑定学号...">
											</div>
											<label id="IpdevNumber-error" class="red error" for="IpdevNumber"></label>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<div class="input-group">
												...
												<input type="email" value="" id="IpdevEmail"  name="devEmail" class="form-control" placeholder="请绑定邮箱...">
											</div>
											<label id="IpdevEmail-error" class="red error" for="IpdevEmail"></label>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>昵称：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<div class="input-group">
												<span class="input-group-addon"><i class="fa fa-user-o"></i></span>
												<input class="form-control input_public" id="IpdevName" type="text" name="devName" value="" placeholder="请输入昵称..." >
											</div>
											<label id="IpdevName-error" class="red error" for="IpdevName"></label>
										</div>

									</div>
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>真实姓名：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<div class="input-group">
												<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
												<input class="form-control input_public" id="IpdevTruename" type="text" name="devTruename" value="" placeholder="请输入真实姓名...">
											</div>
											<label id="IpdevTruename-error" class="red error" for="IpdevTruename"></label>
										</div>

									</div>
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label">实名认证：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" id="idcardDiv" style="padding-right: 0">
											<p class="form-control-static" id="idcardP">

										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label">学校所在地：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<div class="input-group">
												<span class="input-group-addon"><i class="fa fa-mortar-board"></i></span>
												<input class="form-control input_public" id="IpdevSchool" type="text" name="devSchool" value="" placeholder="请输入学校所在地...">
											</div>
											<label id="IpdevSchool-error" class="red error" for="IpdevSchool"></label>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<div class="input-group">
												...
												<input class="form-control" id="IpdevPhone" name="devPhone" type="text" disabled="disabled" value="" placeholder="手机">
											</div>
											<label class="input-group" for=""></label>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<div class="input-group">
												...
												<input class="form-control input_public" id="IpdevLocation" type="text" name="devLocation" value="" placeholder="请输入所在地...">
											</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5 col-md-5 col-lg-5" style="">
											<select id="IpdevSpeciality" name="devSpeciality" class="selectpicker" multiple data-live-search="true" data-max-options="5">
												<option id="OpforumType" disabled>---请选择---</option>
											</select>
											<label for=""></label>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 col-md-9 col-lg-9">
											<textarea class="form-control" name="devInfo" cols="" rows="5" maxlength="200" onchange="this.value=this.value.substring(0, 200)" onkeydown="this.value=this.value.substring(0, 200)" onkeyup="this.value=this.value.substring(0, 200)" placeholder="可输入200字.."></textarea>
