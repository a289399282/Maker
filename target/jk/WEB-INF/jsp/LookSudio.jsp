...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/LookStudioJS.js" type="text/javascript" charset="utf-8"></script>
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 nopadding-left">
	...
	<div class="searchText" >
                            ...
                            <input type="text" placeholder="搜索工作室名称" class="nav-search-input" id="nav-search-input"
	...
	<div class="panel paihang" style="margin-bottom: 30px;">
		<div class="panel-heading">
			<h3 class="panel-title" style="text-align: left;"> <span class="green">|</span>&nbsp;最新工作室</h3>
		</div>
