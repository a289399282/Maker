...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/UpdatePhone.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<form class="form-horizontal" id="UpPhoneFrom">
							<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>新手机号码：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
												<input type="text" value="" id="IpdevPhone"  name="devPhone" class="form-control" placeholder="请输入新手机号码...">
											<label id="IpdevPhone-error" class="red error" for="IpdevPhone"></label>
										</div>
									</div>
							<div class="form-group">
										<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>请输入密码：</label>
										<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
											<input type="password" value="" id="IpdevPassWord"  name="devPassWord" class="form-control" placeholder="请输入密码...">
