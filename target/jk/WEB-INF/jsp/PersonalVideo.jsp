...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/PersonalVideoJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
                                ...
                                <div class="modal-body">
                                    <form  class="form-horizontal" id="updateCompetition">
                                  	<div class="form-group">
										<label class="col-sm-2 col-md-2 col-lg-2 control-label">视频简介：</label>
										<div class="col-sm-8 col-md-8 col-lg-8">
											<textarea class="form-control" id="IdforumInfo" disabled="disabled" name="forumInfo" cols="" rows="3"></textarea>
											<label></label>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 col-md-2 col-lg-2 control-label">视频内容：</label>
										<div class="col-sm-8 col-md-8 col-lg-8">
										<video id="IdforumRoute" height="185" src="" controls="controls">
											<label></label>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 col-md-2 col-lg-2 control-label">上传时间：</label>
										<div class="col-sm-8 col-md-8 col-lg-8">
										<input class="form-control " disabled="disabled" type="text" name="forumReltime" id="IdforumReltime" value="" />
											<label></label>
										</div>
									</div>
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					<h1 class="lead pd-t-20">我的视频
						<span class="pull-right">
							<a href="javacript:void(0)" onclick="removeMuch()" class="btn btn-primary btn-primary-white btn-sm">删除多个视频</a>
							<!--<a href="javacript:void(0)" class="btn btn-primary btn-primary-white btn-sm">修改支付密码</a></span>-->
					</h1>	
					<table class="table text-nowrap" id="TheVideoTable"></table>
