...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/StudioTeamJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
	...
	<body>
        ...
        -->
		    <div class="modal fade" id="UpdateModel" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">组员状态</h4>
                                </div>
                                <div class="modal-body">
                    <form  class="form-horizontal" id="updateStudioTeam">
					...
					<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input type="hidden" name="stuId" id="IdstuId" value="" />
									<input type="hidden" name="devId" id="IddevId" value="" />
					...
					<div class="form-group">
						<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>职位：</label>
						<div class="col-sm-5 col-md-5 col-lg-5" style="">
							<select id="stumemPower" required="required" name="stumemPower" class="selectpicker">
								<option disabled>---请选择---</option>
								<option value="0">等待批准</option>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">组员详情</h4>
                                </div>
                                <div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7 col-md-7 col-lg-7">
								<textarea class="form-control" id="IpdevInfo" name="devInfo" cols="" rows="5" disabled="disabled"></textarea>
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					<h1 class="lead pd-t-20"><span id="IdStudioName"></span>
						<span class="pull-right">
							<!--<a href="javacript:void(0)" onclick="removeMuch()" class="btn btn-primary btn-primary-white btn-sm">开除多个组员</a>-->
