...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath}/js/VideoDetailsJS.js" type="text/javascript" charset="utf-8"></script>
				...
				<div class="row upper">
					...
					<div class="col-md-12">
						<div class="title-area">
							<span class="site-font-18" id="IdVidName" style="font-size: 18px;"></span>&nbsp;&nbsp;
				...
				<div class="row no-margin lower">
					...
					<ul class="nav project-content-tabs">
						<li class="active">
			                ...
			                <a href="#Info" data-toggle="tab">视频简介</a>
			            </li>
						<li>
			                <div class="active-underline"></div>	
			                <a href="#Text" data-toggle="tab">观看视频</a>
			            </li>
						
					</ul>
					<!-- 项目内容项 -->
					<div class="tab-content">
						<div id="Info" class="tab-pane fade active cactive in">
							<p>
							</p>
						<p style="line-height:150%"><strong><span style="font-size:21px;line-height:150%;font-family:'微软雅黑',sans-serif;color:#262626">视频简介</span></strong></p>
						<p style="line-height:150%"><span style=";line-height:150%;font-family:'微软雅黑',sans-serif;color:#7F7F7F" id="IdInfo"> </span></p>
						</div>
						<div id="Text" class="tab-pane fade container">
							<p>
							</p>
						<p style="line-height:150%"><strong><span style="font-size:21px;line-height:150%;font-family:'微软雅黑',sans-serif;color:#262626">视频播放</span></strong></p>
						<p style="line-height:150%"><span style=";line-height:150%;font-family:'微软雅黑',sans-serif;color:#7F7F7F">
							<video width="600" height="" controls="controls">
							<source id="IdRoute" src="" type="video/mp4"></source>
						</video></span></p>
						</div>
