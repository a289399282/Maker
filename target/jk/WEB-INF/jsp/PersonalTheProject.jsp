...
<html>
	<head>
    	...
    	<script src="${pageContext.request.contextPath }/js/PersonalTheProjectJS.js" type="text/javascript" charset="utf-8"></script>
		<style type="text/css">
			.mmDiv {
				display:none;
				}
		    ...
		    <div class="modal fade" id="UpdateModel" tabindex="-1" role="dialog"
					...
					<div class="form-group">
						...
						<div class="col-sm-5 col-md-5 col-lg-5" style="">
							<select id="IpproState" required="required" name="proState" class="selectpicker" >
								<option disabled>---请选择---</option>
								<option value="1">已发布</option>
								<option value="2">已接单</option>
								<option value="3">已驳回</option>
								<option value="4">等待检验</option>
								<option value="5">已通过检验</option>
							</select>
							<label for=""></label>
						</div>
                        ...
                        <div class="modal-dialog" role="document">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input class="form-control"  id="IdproCity" type="text" name="proCity" value=""  disabled="disabled">
								</div>
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
									<input class="form-control"  id="IdproType" type="text" name="proType" value=""  disabled="disabled">
								</div>
							<label id="IdproCity-error" class="red error" for="IdproCity"></label>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
								<div class="input-group">
									...
									<input class="form-control input_public" id="IdproMoney" type="text" name="proMoney" value=""  disabled="disabled" >
								</div>
							<label id="IdproMoney-error" class="red error" for="IdproMoney"></label>
                                ...
                                <div class="form-group">
									<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>创建时间：</label>
									<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
									<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input class="form-control input_public" id="IdproFoutime" type="text" name="proFoutime" value=""  disabled="disabled">
										</div>
									<label id="IdproFoutime-error" class="red error" for="IdproFoutime"></label>
									</div>
									
								</div>
								<div class="form-group">
									<label class="col-sm-3 col-md-3 col-lg-3 control-label"><span class="red">*</span>发布时间：</label>
									<div class="col-sm-5 col-md-5 col-lg-5" style="padding-right: 0">
									<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input class="form-control input_public" id="IdproReltime" type="text" name="proReltime" value=""  disabled="disabled">
										</div>
									<label id="IdproReltime-error" class="red error" for="IdproReltime"></label>
									</div>
								...
								<div class="form-group">
									...
									<div class="input-group">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<input class="form-control input_public" id="IdproEndtime" type="text" name="proEndtime" value=""  disabled="disabled">
										</div>
									...
									<div class="form-group">
										<label class="col-sm-2 col-md-2 col-lg-2 control-label">项目描述：</label>
										<div class="col-sm-8 col-md-8 col-lg-8">
										<textarea class="form-control" id="IdproInfo" disabled="disabled" name="proInfo" cols="" rows="8"></textarea>
											<label></label>
										</div>
									</div>
                                        <div class="modal-footer">
		...
		<div class="col-md-12 nopadding">
			<div class="col-sm-12 col-md-12 col-lg-12 nopadding">
				<div class="refound-account fund-account board">
					...
					<table id="TheProjectTable"></table>
